...
func (l *defaultLogger) Debug(v ...interface{}) {
	_ = l.out[int(LvDebug)](calldepth, header("DEBUG", fmt.Sprintln(v...)))
}
...
func (l *defaultLogger) Info(v ...interface{}) {
	_ = l.out[int(LvInfo)](calldepth, header(color.GreenString("INFO "), fmt.Sprintln(v...)))
}
...
func (l *defaultLogger) Warn(v ...interface{}) {
	_ = l.out[int(LvWarn)](calldepth, header(color.YellowString("WARN "), fmt.Sprintln(v...)))
}
...
func (l *defaultLogger) Error(v ...interface{}) {
	_ = l.out[int(LvError)](calldepth, header(color.RedString("ERROR"), fmt.Sprintln(v...)))
}
...
func (l *defaultLogger) Fatal(v ...interface{}) {
	_ = l.Logger.Output(calldepth, header(color.MagentaString("FATAL"), fmt.Sprintln(v...)))
	os.Exit(1)
}
